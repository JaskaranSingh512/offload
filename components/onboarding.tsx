...
const BrandStep = ({ onNext, onBack }: { onNext: () => void; onBack: () => void }) => {
...
const AudienceStep = ({ onNext, onBack }: { onNext: () => void; onBack: () => void }) => {
...
const ChannelsStep = ({ onNext, onBack }: { onNext: () => void; onBack: () => void }) => {
  const [enabled, setEnabled] = useState<Record<ChannelId, boolean>>({ reddit: true, tiktok: true, instagram: true, x: false });
